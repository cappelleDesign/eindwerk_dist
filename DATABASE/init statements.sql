...
-- review votes
INSERT INTO `review_votes` (`users_voter_id`, `reviews_review_id`, `voted_on_notif_id`, `vote_flag`) VALUES ('1', '1', '1','1'), ('2', '1', '1', '2');
-- comments
...
-- add review_has_comments
-- add video stuff

-- drop DATABASE soufitq169_neoludus